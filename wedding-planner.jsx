        ...
        {!data ? (
          ...
          <Card>
            ...
            {membersOf(sel).length > 0 ? (
              <div className="mt-4">
                <div className="text-sm font-semibold mb-2">Who's here? Tap names</div>
...
function Guests({ data, up, side }) {
  const [form, setForm] = useState({ name: "", side: side || "bride", group: "", invitedPax: 2, phone: "", members: [{ name: "", type: "adult" }] });
  ...
  const add = () => {
    ...
    setForm({ name: "", side: side || form.side, group: form.group, invitedPax: 2, phone: "", members: [{ name: "", type: "adult" }] });
  };
