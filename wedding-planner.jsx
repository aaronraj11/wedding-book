      ...
      <div className="w-full max-w-md">
        ...
        {!data ? (
          ...
          <Card>
            ...
            <div className="mt-4">
              <Field label="How many of you are here today?">
                <input style={{ ...inputStyle, width: 120 }} type="number" min="1" value={pax} onChange={(e) => setPax(e.target.value)} />
              </Field>
            </div>
...
function Guests({ data, up, side }) {
  const [form, setForm] = useState({ name: "", side: side || "bride", group: "", invitedPax: 2, invitedBabies: 0, phone: "" });
  ...
  const add = () => {
    ...
    const pax = num(form.invitedPax) || 1;
    const g = {
      id: uid(),
      name: form.name.trim(),
      side: side || form.side,
    ...
    setForm({ name: "", side: side || form.side, group: form.group, invitedPax: 2, invitedBabies: 0, phone: "" });
  };
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <p className="text-xs mt-1 mb-3" style={{ color: C.muted }}>
            ...
            pending guests. Recognised columns: <b>Name</b> (required), Side, Group, Pax, Babies, Phone.
          </p>
          <input
            ref={guestFileRef}
            type="file"
